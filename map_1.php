...
<div id="search-canvas" class="map-canvas"></div>
<script src="../jquery-1.11.3.min.js"></script>
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA890xJPPqBNULWSmlA1duYt3CTYEzHQ10&libraries=places,visualization" async defer></script>
...
jQuery(function () {
	 ...
	 jQuery('#search-canvas').googleMaps({
	    controls: {
			localSearch: true
		}
    }); 
